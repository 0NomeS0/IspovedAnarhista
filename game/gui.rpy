...
define gui.text_font = "Daneehand Regular Cyr.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "Daneehand Regular Cyr.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "Daneehand Regular Cyr.ttf"
...
define gui.main_menu_background = "gui/main_menu.png"#Movie(video = "video/main_menu.ogv" , loop = True, size = (1920,1080))   #
...
## порядку.
define gui.namebox_borders = Borders(5, 5, 5, 5) #(15,7,15,7)
...
define gui.dialogue_xpos = 402 #0.5#
...
## левоориентированного, 0.5 для центрированного и 1.0 для правоориентированного
## выравнивания.
define gui.dialogue_text_xalign = 0.0 #0.5#
...
init python:
    ...
    def small():
        ...
        gui.name_xpos = 0.5#120
        gui.dialogue_xpos = 0.5#135
        gui.dialogue_width = 1650

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 74#54
