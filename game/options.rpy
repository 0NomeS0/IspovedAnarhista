...
define config.name = _("Исповедь Анархиста")
...
define build.name = "IspovedAnarhista"
...
define config.main_menu_music = "audio/music/test.mp3"
...
define config.save_directory = "IspovedAnarhista-1734378091"
