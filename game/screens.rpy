...
style choice_button is default:
    ...
    activate_sound "audio/sounds/click.ogg"
    hover_sound "audio/sounds/soundPaper.ogg"
...
style navigation_button_text:
    ...
    outlines [(absolute(2),"#8b0000",absolute(10),absolute(0))]
    xalign 0.5
